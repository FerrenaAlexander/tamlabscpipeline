...
#' @param removemitomaxclust T/F ; whether to remove the mito max cluster after first-pass clustering; if no baseline mito filtration is used, there will almost certainly be a mito-driven cluster. Default is True.
